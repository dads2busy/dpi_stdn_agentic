...
def validate_config(config_data: dict) -> dict:
    ...
    defaults = {
        ...
        "component_no_debate_top_p": 0.000001,
        "component_debate_temperature": None,
        "component_no_debate_temperature": None,
        "material_debate_top_p": 0.0001,
        "material_no_debate_top_p": 0.000001,
        "material_debate_temperature": None,
        "material_no_debate_temperature": None,
        "country_debate_top_p": 0.0001,
        "country_no_debate_top_p": 0.000001,
        "country_debate_temperature": None,
        "country_no_debate_temperature": None,
